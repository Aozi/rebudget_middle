...
manager.create_api(bank_User, methods=['GET', 'POST', 'PATCH' 'DELETE'], page_size=0, allow_patch_many=True, allow_delete_many=True)
manager.create_api(Transaction, methods=['GET', 'POST', 'DELETE'], page_size=0)
